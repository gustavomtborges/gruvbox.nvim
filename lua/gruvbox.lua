...
local function get_groups()
  ...
  local groups = {
    ...
    ["@define"] = { link = "Define" },
    ["@operator"] = { link = "GruvboxWhite" },
    ["@punctuation.delimiter"] = { link = "GruvboxWhite" },
    ["@punctuation.bracket"] = { link = "GruvboxWhite" },
    ["@punctuation.special"] = { link = "GruvboxWhite" },
    ["@string"] = { link = "String" },
    ["@string.regex"] = { link = "String" },
    ["@string.regexp"] = { link = "String" },
    ["@string.escape"] = { link = "SpecialChar" },
    ["@string.special"] = { link = "GruvboxWhite" },
    ...
    ["@type"] = { link = "Type" },
    ["@type.builtin"] = { link = "GruvboxOrange" },
    ["@type.definition"] = { link = "Typedef" },
    ["@type.qualifier"] = { link = "Type" },
    ["@storageclass"] = { link = "StorageClass" },
    ["@attribute"] = { link = "PreProc" },
    ["@field"] = { link = "Identifier" },
    ["@property"] = { link = "GruvboxWhite" },
    ["@variable"] = { link = "GruvboxBlue" },
    ["@variable.builtin"] = { link = "Special" },
    ["@variable.member"] = { link = "Identifier" },
    ["@variable.parameter"] = { link = "GruvboxWhite" },
    ...
    ["@tag"] = { link = "GruvboxAqua" },
    ["@tag.attribute"] = { link = "GruvboxYellow" },
    ["@tag.operator"] = { fg = colors.fg0 },
    ["@tag.delimiter"] = { link = "GruvboxBlue" },
    ["@punctuation"] = { link = "GruvboxPurple" },
    ["@macro"] = { link = "Macro" },
